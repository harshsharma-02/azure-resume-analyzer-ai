    ...
    <AuthShell
      ...
      title={
        <>
          Welcome
          <br />
          <em className="text-gradient not-italic italic">back.</em>
        </>
      }
    ...
    <div className="bg-nocturne min-h-screen flex items-center justify-center px-6 py-16 relative overflow-hidden">
      <div
        ...
        style={{
          ...
          width: "500px",
          height: "500px",
          background: "radial-gradient(circle, #4a7dff, transparent 60%)",
        }}
      />
      <div
        aria-hidden
      ...
      >
        <Link
          to="/"
          className="inline-flex items-center gap-2 chip mb-8 hover:border-white/30"
        >
          ← Back home
        </Link>
        <div className="eyebrow">{eyebrow}</div>
        <h1 className="mt-4 font-display text-5xl text-white leading-[0.95]">
          {title}
        </h1>
        <p className="mt-4 text-[#a5b4d0] text-[15px] leading-relaxed">
          {subtitle}
        </p>
